...
type Props = {
  size?: number;
  /** Default matches `assets/icons/iconsax-people.svg` stroke on dark; use `#717680` on light fields. */
  color?: string;
};

/** `assets/icons/iconsax-people.svg` */
export function IconsaxPeopleIcon({ size = 24, color = '#FFFFFF' }: Props) {
