...
type Props = {
  size?: number;
  /** Default white for use on blue hero cards (`assets/icons/iconsax-medal-filled.svg`). */
  color?: string;
};

/** `assets/icons/iconsax-medal-filled.svg` */
export function IconsaxMedalFilledIcon({ size = 24, color = '#FFFFFF' }: Props) {
  return (
