...
/** `assets/icons/iconsax-tag-user-filled.svg` */
export function IconsaxTagUserFilledIcon({ size = 24, color = '#2970FF' }: Props) {
  ...
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      <G clipPath={`url(#${clipId})`}>
        <Path
          d="M12.07 8.9498C12.03 8.9498 11.97 8.9498 11.92 8.9498C10.87 8.9098 10.04 8.0598 10.04 6.9998C10.04 5.9198 10.91 5.0498 11.99 5.0498C13.07 5.0498 13.94 5.9298 13.94 6.9998C13.95 8.0598 13.12 8.9198 12.07 8.9498Z"
          fill={color}
        />
        <Path
