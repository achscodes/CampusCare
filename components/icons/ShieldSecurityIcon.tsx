...
type ShieldSecurityIconProps = {
  size?: number;
  color?: string;
};

export function ShieldSecurityIcon({ size = 24, color = '#000' }: ShieldSecurityIconProps) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      <G clipPath="url(#clip0_4418_9539)">
        <Path
