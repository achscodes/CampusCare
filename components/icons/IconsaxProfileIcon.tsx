...
/** `assets/icons/iconsax-profile.svg` */
export function IconsaxProfileIcon({ size = 24, color = '#717680' }: Props) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      <G clipPath="url(#iconsax_profile_clip)">
        <Path
      ...
      <Defs>
        <ClipPath id="iconsax_profile_clip">
